...
export class A2UILayoutEditor extends SignalWatcher(LitElement) {
  ...
  #maybeRenderForm() {
    ...
    return html` <form
      @submit=${async (evt: Event) => {
        ...
        //TODO:  Sends message after the user typed.
  ...
  // TODO: function in charge of sending A2A messages
  async #sendMessage(
  ...
  #maybeRenderData() {
    ...
    // TODO: data gets finally rendered as in react
  ...
  // TODO: method to process message, then build the surface.
  async #sendAndProcessMessage(request) {
    ...
    // TODO: method to differenciate messages and render component by component.
